...
const Home: NextPage = () => {
  ...
  return (
    <Container>
      <Navbar />
      <CustomSection className="heroSection h-[120vh] relative">
        <CustomSection className="bg-[rgba(0,_0,_0,_0.06] backdrop-blur-[2px] w-[50%] absolute top-[25%] left-[7%] p-[20px]">
      ...
      <CustomSection>
        <div className="w-full flex justify-between bg-[#F3F3F3] items-center p-[2rem]">
          <CustomImage
          ...
          <div className="itemTwo bg-[#430990] w-[50%] p-2 md:p-5 text-[#F1F1F1]">
            <div className="head">
      ...
      <CustomSection className="pb-[3rem] bg-[#F2F2F2] relative">
      ...
      <CustomSection className="bg-[#430990] flex items-center p-[2rem] justify-between">
        <div className="w-[20%] flex items-center justify-center">
          <h2 className="text-[3.44rem] text-[#F1F1F1] font-[800]">
            The <br />
            Why?
          </h2>
        </div>
