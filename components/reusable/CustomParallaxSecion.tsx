...
const CustomParallaxSecion = ({
  ...
  return (
    <div className='w-full bg-[#ECE6F4] flex flex-col lg:flex-row justify-between items-center lg:odd:flex-row-reverse mb-6 lg:mb-0'>
      <div className='itemOne relative w-full lg:w-[710px] h-[345px] lg:h-[545px]'>
        <Image alt='' layout='fill' src={img} />
      </div>

      <div className='itemTwo bg-[#ECE6F4] w-full lg:w-[50%] px-4 lg:px-12'>
        <div className='head'>
